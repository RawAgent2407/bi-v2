...
const ContactSection = () => {
  return (
    <div className=" flex lg:p-0 flex-col lg:flex-row sm:flex-col-reverse overflow-hidden  sm:p-16 sm:py-10 sm:pt-20">
      {/* Left Info */}
      <div
        className=" sm:p-10 lg:p-12 lg:p-20 lg:space-y-8 border-b md:border-b-0 lg:border-r lg:w-2/5 sm:w-full sm:bg-white sm:p-20 sm:gap-8 sm:flex sm:flex-col sm:items-start sm:justify-start"
        style={{ flex: '0 0 40%' }}
      >
        <div>
      ...
      {/* Right Form */}
      <div
        className="bg-[#E7E5E2]  sm:py-16 sm:px-10 lg:p-12 lg:p-16 lg:w-3/5 sm:w-full"
        style={{ flex: '0 0 60%' }}
      >
        <form className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:gap-4 sm:gap-2">
            <input
              type="text"
              placeholder="FIRST NAME"
              className="w-full border text-sm px-4 py-3 rounded outline-none focus:ring-1 focus:ring-black bg-white"
            />
            <input
              type="text"
